...
<html lang="en">
  <head>
    ...
    />
    <link
      href="https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700&family=Kanit:wght@400;500;600&family=Merienda:wght@500;700&family=Plus+Jakarta+Sans&family=Poppins:wght@400;500;600&family=Red+Rose:wght@700&family=Roboto&family=Rubik:wght@600&display=swap"
      rel="stylesheet"
    />
  ...
  <body class="bg-light">
    ...
    >
      <div class="container-fluid">
        <a class="navbar-brand me-5 fw-bold fs-2 h-font" href="index.php"
          >Hotel Booking</a
        >
        <button
    ...
    <!-- Our Room -->
    <div class="mt-5 pt-4 mb-5 text-center fw-bold h-font fs-2">OUR ROOMS</div>
          ...
          >
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-evenly">
                <a href="#" class="btn btn-sm custom-bg shadow-none text-white"
                  >Book Now</a
                >
    ...
    <!-- Reach Us -->
    <div class="mt-5 pt-4 mb-5 text-center fw-bold h-font fs-2">REACH US</div>
    ...
    <!-- Footer -->
    <footer class="bg-white mt-5 text-white text-center text-lg-start">
      <!-- Grid container -->
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-12 mb-4 mb-md-0 text-dark">
            ...
            <p>
              ...
              doloribus ut at esse praesentium minus voluptate, excepturi
              tempore. Ex assumenda aliquid vero quas in nostrum asperiores quae
              et praesentium nemo.
            </p>
          </div>
          <!--Grid column-->
          ...
          <div class="col-lg-3 col-md-6 mb-4 mb-md-0 text-dark">
            ...
            <a
              href="#"
              class="d-inline-block text-dark text-decoration-none mb-3 pt-2 text-dark"
            >
              <i class="bi bi-twitter-x me-1"></i> Twitter
            </a>
            <br />
            ...
            <a
              href="#"
              class="d-inline-block text-dark text-decoration-none pt-2 text-dark"
            >
              <i class="bi bi-instagram me-1"></i> Instagram
            </a>
          </div>
      ...
      <div class="text-center text-dark bg-white p-3">
        © 2020 Copyright:
        <a class="text-dark" href="">CRJ Software Technology Pvt Ltd.</a>
      </div>
      <!-- Copyright -->
    </footer>
